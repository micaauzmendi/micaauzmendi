...
export function Epilogue({ dict }: { dict: Dictionary }) {
  ...
  const greetingRest = greetingTailParts.join(" ");
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-14 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
        ...
        <div>
          ...
          <h2 id="epilogo-heading" className="mt-5 font-heading text-4xl font-medium leading-tight text-text sm:text-5xl">
            ...
            {greetingRest ? (
              <>
                {" "}
                <RevealText delay={0.12}>{greetingRest}</RevealText>
              </>
            ) : null}
          </h2>
