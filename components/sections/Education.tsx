...
export function Education({ dict }: { dict: Dictionary }) {
  ...
  return (
    <section id="formacion" aria-labelledby="formacion-heading" className="px-6 py-24 md:px-10 md:py-32">
      <div className="mx-auto max-w-4xl">
        <SectionHeading id="formacion-heading" eyebrow={dict.education.eyebrow} title={dict.education.title} />

        <Reveal delay={0.1} className="mt-14 grid grid-cols-1 gap-10 sm:grid-cols-3">
          <div>
            <h3 className="font-mono text-xs uppercase tracking-wider text-accent">{educationUi.degree}</h3>
            <p className="mt-3 font-heading text-lg font-semibold text-text">{educationData.degree.title}</p>
          ...
          <div className="sm:border-l sm:border-accent-support/40 sm:pl-10">
            <h3 className="font-mono text-xs uppercase tracking-wider text-accent">{educationUi.certifications}</h3>
          ...
          <div className="sm:border-l sm:border-accent-support/40 sm:pl-10">
            <h3 className="font-mono text-xs uppercase tracking-wider text-accent">{educationUi.languages}</h3>
